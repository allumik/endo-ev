...
def preproc_sc(gen_sc):
  gen_ccht_ev = ov.pp.preprocess(gen_sc, mode="shiftlog|pearson", n_HVGs=2000)
  ov.pp.scale(gen_sc)
  ov.pp.pca(gen_sc, layer='scaled', n_pcs=50)

  gen_sc.obsm['X_pca']=gen_sc.obsm['scaled|original|X_pca']
  ov.pl.embedding(
    gen_sc,
    basis='X_pca',
    color='celltype',
