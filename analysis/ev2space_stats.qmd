...
all_results = (
  all_results
  .assign(
    cyclephase=lambda df: np.select(
      condlist=[
        df["slide_id"].str.startswith("CTR"),
        df["slide_id"].isin(["152807", "152811"])
      ],
      choicelist=["Mid-secretory", "Early-secretory"],
      default="Proliferative"
    )
  )
)
